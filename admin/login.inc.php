...
DT_LICENSE == strtoupper(md5(file_get(DT_ROOT.'/license.txt'))) or msg('license.txt不可修改或刪除，請檢查');
if(!$forward) $forward = '?';
