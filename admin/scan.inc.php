...
$menus = array (
    array('木馬掃瞄', '?file='.$file),
    array('文件校驗', '?file=md5'),
);
$sys = array('admin', 'api', 'include', 'javascript', 'lang', 'module', 'template', 'wap');
$bd_code = 'VBScript.Encode|GetProcesses|gzuncompress|gzinflate|passthru|eval|base64_decode|shell|zend|exec|cmd|soname|windows|000000|fso.|.exe|.dll|孱|提權|掛馬|木馬';
