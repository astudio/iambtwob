...
<a href="./" target="_blank"><img src="admin/image/home.gif" width="8" height="8" title="網站首頁"/></a>&nbsp;
<a href="?action=start" target="_top"><img src="admin/image/reload.gif" width="8" height="8" title="刷新(返回後台起始頁)"/></a>&nbsp;
<a href="?file=logout" target="_top" onclick="if(!confirm('確實要註銷登錄嗎?')) return false;"><img src="admin/image/quit.gif" width="8" height="8" title="註銷登錄"/></a>
</td>
<td width="5"></td>
</tr>
</table>
...
<div style="display:none;">
	...
	<?php if($_founder) { ?>
	<dl> 
	<dt onclick="s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">系統設置</dt> 
	<?php
	...
	<?php } ?>
	<dl> 
	<dt onclick="s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">更新數據</dt>
	<dd onclick="c(this);"><a href="?action=html">生成首頁</a></dd>
	<?php if($_founder) { ?>
	<dd onclick="c(this);"><a href="?action=cache">更新緩存</a></dd>
	<dd onclick="c(this);"><a href="?moduleid=3&file=html">更新擴展</a></dd>
	<dd onclick="c(this);"><a href="?file=html" onclick="return confirm('確定要開始更新全站頁面嗎？此操作比較耗費服務器資源和時間 ');">更新全站</a></dd>
	<?php } ?>
	</dl>
	<dl> 
	<dt onclick="s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">系統工具</dt>
	<?php
		foreach($menu as $m) {
			echo '<dd onclick="c(this);"><a href="'.$m[1].'">'.$m[0].'</a></dd>';
		}
	...
	<div id="m_2">
	<dl>
	<dt onclick="s(this)" onmouseover="this.className='dt_on';" onmouseout="this.className='';">使用幫助</dt>
	<?php
	...
	<?php
		...
		if(is_file($menuinc)) {
			...
			echo '<dt onclick="m('.$moduleid.');" onmouseover="this.className=\'dt_on\';" onmouseout="this.className=\'\';">擴展功能</dt>';
			foreach($menu as $m) {
				echo '<dd onclick="c(this);" style="display:none;"><a href="'.$m[1].'">'.$m[0].'</a></dd>';
			}
			echo '</dl>';
	...
	?>
	<dl id="dl_pay"> 
	<dt id="dt_pay" onclick="s(this);h(Dd('dt_oth'));h(Dd('dt_4'));" onmouseover="this.className='dt_on';" onmouseout="this.className='';">財務管理</dt>
	<?php
	...
	<dl id="dl_oth"> 
	<dt id="dt_oth" onclick="s(this);h(Dd('dt_pay'));h(Dd('dt_4'));" onmouseover="this.className='dt_on';" onmouseout="this.className='';">會員相關</dt> 
	<?php
