...
<td width="80">&nbsp;鏡像文件</td>
<td>
&nbsp;<input type="submit" name="submit" value="開始校驗" class="btn"/>
&nbsp;<input type="submit" name="submit" value="刪除鏡像" class="btn"/>
</td>
</tr>
</table>
</form>
...
<tr>
<td></td>
<td height="30">&nbsp;<input type="submit" name="submit" value="創建鏡像" class="btn"/></td>
</tr>
</table>
</form>
