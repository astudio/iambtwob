...
<a href="?file=<?php echo $file;?>&action=delete&catid=<?php echo $v['catid'];?>&oid=<?php echo $v['oid'];?>" onclick="return _delete();"><img src="admin/image/delete.png" width="16" height="16" title="刪除" alt=""/></a>
</td>
</tr>
<?php } ?>
</table>
...
<input type="button" value=" 關 閉 " class="btn" onclick="window.parent.location.reload();;"/>
</div>
</form>
