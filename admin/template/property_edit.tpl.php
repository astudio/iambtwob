...
<div class="tt"><?php echo $action=='add' ? '添加' : '修改';?>屬性</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl"><span class="f_red">*</span> 屬性名稱</td>
...
<tr style="display:">
<td class="tl" id="v_l"><span class="f_hid">*</span> 默認值</td>
...
<td class="tl"><span class="f_red">*</span> 參與搜索</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 擴展代碼</td>
<td><textarea name="post[extend]" style="width:98%;height:30px;overflow:visible;"><?php echo $extend;?></textarea></td>
</tr>
</table>
<div class="sbt"><input type="submit" name="submit" value=" 確 定 " class="btn"/>&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" value=" 關 閉 " class="btn" onclick="window.parent.location.reload();;"/></div>
</form>
<script type="text/javascript">
function c(id) {
	if(id == 2 || id == 3) {
		Dd('v_l').innerHTML = '<span class="f_red">*</span> 備選值';
		Dd('v_r').innerHTML = '多個選項用 | 分隔，例如 紅色|綠色(*)|藍色 (*)表示默認選中';
		Ds('s_c');
	} else if(id == 0 || id == 1) {
		Dd('v_l').innerHTML = '<span class="f_hid">*</span> 默認值';
		Dd('v_r').innerHTML = '';
		Dh('s_c');
	}
}
