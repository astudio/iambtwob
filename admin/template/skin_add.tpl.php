...
<tr>
<td colspan="2"><input type="checkbox" name="nowrite" value="1" checked/> 如果風格已經存在,請不要覆蓋&nbsp;&nbsp;<input type="submit" name="submit" value="保 存" class="btn"/>&nbsp;&nbsp;<input type="button" value="返 回" class="btn" onclick="history.back(-1);"/>&nbsp;&nbsp;<input type="reset" value="重 置" class="btn"/>&nbsp;&nbsp;<input type="button" value="縮 小" class="btn" onclick="Zoom('-');"/>&nbsp;&nbsp;<input type="button" value="放 大" class="btn" onclick="Zoom('+');"/></td>
</tr>
</table>
</form>
<br/>
