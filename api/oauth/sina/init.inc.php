...
{ 
     ...
     * @param int $count 每次返回的最大記錄數（即頁面大小），不大於200，默認為20。 
     * @return array 
     */ 
     ...
     * @param string $text 要發佈的圖片路徑,支持url。[只支持png/jpg/gif三種格式,增加格式請修改get_image_mime方法] 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 用戶UID或微博暱稱。 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param bool $cursor 單頁只能包含100個關注列表，為了獲取更多則cursor默認從-1開始，通過增加或減少cursor來獲取更多的關注列表 
     * @param bool $count 每次返回的最大記錄數（即頁面大小），不大於200,默認返回20 
     ...
     *  
     * @access public 
     * @param bool $cursor 單頁只能包含100個粉絲列表，為了獲取更多則cursor默認從-1開始，通過增加或減少cursor來獲取更多的粉絲列表 
     * @param bool $count 每次返回的最大記錄數（即頁面大小），不大於200,默認返回20。 
     * @param mixed $uid_or_name  要獲取的 UID或微博暱稱 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 要關注的用戶UID或微博暱稱 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 要取消關注的用戶UID或微博暱稱 
     * @return array 
     */ 
     ...
     *  
     * @access public 
     * @param mixed $uid_or_name 要判斷的用戶UID 
     * @return array 
     */ 
     ...
     * @access public 
     * @param int $page 頁碼 
     * @param int $count 每次返回的最大記錄數，最多返回200條，默認20。 
     * @param mixed $uid_or_name 指定用戶UID或微博暱稱 
     * @return array 
     */ 
     ...
     * @param mixed $text 要發生的消息內容，文本大小必須小於300個漢字。 
     * @return array 
     */ 
    ...
    /** 
     * 返回用戶的發佈的最近20條收藏信息，和用戶收藏頁面返回內容是一致的。 
     *  
     * @access public 
