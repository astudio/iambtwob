...
require_once DT_ROOT.'/api/trade/alipay/1/pay/alipay_core.function.php';
class AlipaySubmit {
	/**
     * 生成要請求給支付寶的參數數組
	...
	function buildForm($para_temp, $gateway, $method, $button_name, $aliapy_config) {
        ...
        //DT$sHtml = $sHtml."<input type='submit' value='".$button_name."'></form>";
        $sHtml = $sHtml."</form>";
		
		//DT $sHtml = $sHtml."<script>document.forms['alipaysubmit'].submit();</script>";
