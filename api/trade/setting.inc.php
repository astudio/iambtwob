...
<img src="<?php echo DT_PATH;?>api/trade/alipay/ico.gif" align="absmiddle"/> <a href="<?php echo $MODULE[3]['linkurl'];?>redirect.php?url=https://b.alipay.com/order/productDetail.htm?productId=2011042200323187" target="_blank" class="t">[申請帳號]</a>
</td>
</tr>
...
<tr>
<td class="tl">介面類別型</td>
<td>
<select name="setting[trade_tp]">
<option value="0" <?php if($trade_tp == 0) echo 'selected';?>>平臺商擔保交易</option>
<option value="1" <?php if($trade_tp == 1) echo 'selected';?>>平臺商雙功能</option>
</select> <?php tips('建議申請 平臺商擔保交易');?>
</td>
</tr>
<tr>
<td class="tl">接收伺服器通知檔案名</td>
<td><input type="text" size="30" name="setting[trade_nu]" value="<?php echo $trade_nu;?>"/> <?php tips('默認為notify.php 保存於 api/trade/alipay/1/notify.php(平臺商擔保交易)和api/trade/alipay/2/notify.php(平臺商雙功能)<br/>建議你修改此檔案名，然後在此填寫新檔案名，以防受到騷擾');?></td>
</tr>
</tbody>
