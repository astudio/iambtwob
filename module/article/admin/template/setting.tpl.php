...
<tr>
<td class="tl">內容顯示上一篇下一篇</td>
<td>
<input type="radio" name="setting[show_np]" value="1"  <?php if($show_np) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_np]" value="0"  <?php if(!$show_np) echo 'checked';?>/> 關閉
<?php tips('此項會略微增加服務器負擔');?>
</td>
</tr>
</table>
</div>
