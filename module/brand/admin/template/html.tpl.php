...
<input type="submit" value=" 更新品牌 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';" title="更新該模塊所有品牌地址等項目"/>
</td>
</tr>
</table>
</form>
...
<input type="submit" value=" 更新品牌 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';"/>
</td>
</tr>
</table>
</form>
