...
if(in_array($action, array('', 'check', 'expire', 'reject', 'recycle'))) {
	$sfields = array('模糊', '標題', '產品名稱', '需求數量', '價格要求', '規格要求', '包裝要求', '簡介', '公司名', '聯繫人', '聯繫電話', '聯繫地址', '電子郵件', '聯繫MSN', '聯繫QQ', '會員名', 'IP');
	...
	$sorder  = array('結果排序方式', '更新時間降序', '更新時間升序', '添加時間降序', '添加時間升序', '瀏覽次數降序', '瀏覽次數升序', '信息ID降序', '信息ID升序');
