...
<td><input name="post[tag]" id="tag" type="text" size="30" value="<?php echo $tag;?>" onkeyup="_p();"/><span id="reccate" style="display:none;"> <a href="javascript:" onclick="reccate(<?php echo $moduleid;?>, 'tag');" class="t">[分類建議]</a></span> <span id="dtag" class="f_red"></span></td>
</tr>
-->
<tr>
