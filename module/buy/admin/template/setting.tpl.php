...
<td><input type="text" size="3" name="setting[pagesize]" value="<?php echo $pagesize;?>"/> 條</td>
</tr>
...
<tr>
<td class="tl">報價啟用驗證碼</td>
<td>
<input type="radio" name="setting[captcha_price]" value="2"  <?php if($captcha_price == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_price]" value="1"  <?php if($captcha_price == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_price]" value="0"  <?php if($captcha_price == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">報價啟用驗問題</td>
<td>
<input type="radio" name="setting[question_price]" value="2"  <?php if($question_price == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_price]" value="1"  <?php if($question_price == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_price]" value="0"  <?php if($question_price == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
