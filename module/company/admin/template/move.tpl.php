...
<tr class="on">
<td>
<input type="radio" name="fromtype" value="areaid" id="f_2"/><label for="f_2">從地區ID</label>&nbsp;&nbsp;
<input type="radio" name="fromtype" value="userid" <?php echo $userid ? 'checked' : '';?> id="f_3"/><label for="f_3">從會員ID</label>
</td>
<td></td>
<td>&nbsp;目標地區</td>
</tr>
<tr>
<td width="250" align="center" title="多個ID用,分開 結尾和開頭不能有,">
