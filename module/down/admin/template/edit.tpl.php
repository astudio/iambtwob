...
<tr>
<td class="tl"><span class="f_red">*</span> 文件地址</td>
<td><input name="post[fileurl]" id="fileurl" type="text" size="60" value="<?php echo $fileurl;?>"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('fileurl').value, 'fileurl', '<?php echo $MOD['upload'];?>');" class="jt">[上傳]</span>&nbsp;&nbsp;<span onclick="if(Dd('fileurl').value) window.open(Dd('fileurl').value);" class="jt">[預覽]</span>&nbsp;&nbsp;<span onclick="Dd('fileurl').value='';" class="jt">[刪除]</span> <span id="dfileurl" class="f_red"></span></td>
</tr>
<?php } ?>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 下載說明</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 下載系列</td>
<td><input name="post[tag]" id="tag" type="text" size="50" value="<?php echo $tag;?>"/> <span id="dtag" class="f_red"></span><?php tips('填寫一個下載的關鍵詞或者系列名稱，以便關聯同系列的下載');?></td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 下載次數</td>
