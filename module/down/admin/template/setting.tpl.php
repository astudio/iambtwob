...
<tr>
<td class="tl">PHP讀取文件限制</td>
<td><input type="text" size="5" name="setting[readsize]" value="<?php echo $readsize;?>"/> M <?php tips('對於同服務器上的文件，用php讀取方式下載不會暴露文件的真實地址，但是讀取大文件比較耗費服務器資源<br/>超過此限制大小的文件，將不再用php讀取方式下載<br/>填0表示從不用php讀取方式下載');?></td>
</tr>
<tr>
<td class="tl">允許上傳下載的文件類型</td>
