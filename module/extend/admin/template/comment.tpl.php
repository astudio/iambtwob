...
<?php if($v['reply']) { ?>
<br/>
<span class="f_red"><?php echo $v['editor'] ? '管理員'.$v['editor'] : $v['replyer'];?> <?php echo $v['replydate'];?> 回復</span><br/><?php echo nl2br($v['reply']);?>
<?php } ?>
</div>
<div class="b5 c_b"> </div>
...
<div class="btns">
<input type="submit" value=" 刪 除 " class="btn" onclick="if(confirm('確定要刪除選中評論嗎？此操作將不可撤銷')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;
<?php if($action == 'check') { ?>
