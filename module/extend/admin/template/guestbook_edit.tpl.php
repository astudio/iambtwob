...
<td><a href="javascript:_user('<?php echo $username;?>');" class="t"><?php echo $username ? $username : 'Guest';?></a>&nbsp; IP:<?php echo $ip;?> 來自 <?php echo ip2area($ip);?> <input type="checkbox" name="post[hidden]" value="1" <?php if($hidden) echo 'checked';?>/> 匿名留言</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 留言內容</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 回復留言</td>
<td><textarea name="post[reply]" id="reply" rows="8" cols="70"><?php echo $reply;?></textarea></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 前台顯示</td>
<td>
