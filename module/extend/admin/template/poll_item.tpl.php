...
<form action="?">
<div class="tt">[<?php echo $P['title'];?>]選項搜索</div>
...
<input type="hidden" name="action" value="<?php echo $action;?>"/>
<input type="hidden" name="itemid" value="<?php echo $itemid;?>"/>
<div class="tt">[<?php echo $P['title'];?>]選項管理</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<th width="40">刪除</th>
<th>排序</th>
...
<a href="<?php echo $v['linkurl'];?>" target="_blank"><img src="<?php echo $MODULE[2]['linkurl'];?>image/img_select.gif" width="12" height="12" title="新窗口打開鏈接"/></a>
</td>
...
<td><a href="###" onclick="Dwindow('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&pollid=<?php echo $v['pollid'];?>&itemid=<?php echo $v['itemid'];?>', '投票記錄[<?php echo $P['title'];?>]');"><img src="admin/image/poll.png" width="16" height="16" title="投票記錄" alt=""/></a></td>
</tr>
<?php } ?>
<tr>
<th width="40"><input type="checkbox" onclick="checkall(this.form);" title="全選/反選"/></th>
<th>排序</th>
<th>標題</th>
<th>鏈接</th>
<th>簡介</th>
...
<tr>
<td> </td>
<td height="30" colspan="8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value="更 新" onclick="if(_del && !confirm('提示:您選擇刪除'+_del+'個選項？確定要刪除嗎？')) return false;" class="btn"/>
</td>
</tr>
<tr>
