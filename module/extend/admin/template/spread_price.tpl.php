...
<tr>
<td> </td>
<td height="30" colspan="7">&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="submit" value=" 更 新 " onclick="if(_del && !confirm('提示:您選擇刪除'+_del+'個價格項目？確定要刪除嗎？')) return false;" class="btn"/></td>
</tr>
</table>
</form>
