...
<a href="###" onclick="Dwindow('?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=record&itemid=<?php echo $v['itemid'];?>', '投票記錄[<?php echo $v['title'];?>]');"><img src="admin/image/poll.png" width="16" height="16" title="投票記錄" alt=""/></a>&nbsp;
...
<div class="btns">
<input type="submit" value=" 刪 除 " class="btn" onclick="if(confirm('確定要刪除選中投票嗎？此操作將不可撤銷')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;
