...
<tr>
<td class="tl">首頁默認模板</td>
<td><?php echo tpl_select('index', $module, 'setting[template_index]', '默認模板', $template_index);?></td>
</tr>
<tr>
<td class="tl">列表默認模板</td>
<td><?php echo tpl_select('list', $module, 'setting[template_list]', '默認模板', $template_list);?></td>
</tr>
<tr>
<td class="tl">內容默認模板</td>
<td><?php echo tpl_select('show', $module, 'setting[template_show]', '默認模板', $template_show);?></td>
</tr>
<tr>
<td class="tl">搜索默認模板</td>
<td><?php echo tpl_select('search', $module, 'setting[template_search]', '默認模板', $template_search);?></td>
</tr>
<tr>
<td class="tl">留言默認模板</td>
<td><?php echo tpl_select('message', $module, 'setting[template_message]', '默認模板', $template_message);?></td>
</tr>
<tr>
...
<option value="editdate desc,vip desc,edittime desc"<?php if($order == 'editdate desc,vip desc,edittime desc') echo ' selected';?>>更新日期,<?php echo VIP;?>級別,更新時間</option>
<option value="adddate desc,vip desc,addtime desc"<?php if($order == 'adddate desc,vip desc,addtime desc') echo ' selected';?>>添加日期,<?php echo VIP;?>級別,添加時間</option>
...
<tr>
<td class="tl">編輯器批量傳圖</td>
<td>
<input type="radio" name="setting[swfu]" value="0"  <?php if($swfu==0) echo 'checked';?>/> 關閉&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[swfu]" value="1"  <?php if($swfu==1) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[swfu]" value="2"  <?php if($swfu==2) echo 'checked';?>/> 後台開啟 <?php tips('開啟後，編輯器下將增加批量傳圖功能，方便內容插入圖片');?>
</td>
</tr>
<tr>
<td class="tl">首頁推薦信息數量</td>
...
<tr>
<td class="tl">首頁顯示按分類瀏覽</td>
<td>
<input type="radio" name="setting[show_icat]" value="1"  <?php if($show_icat) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_icat]" value="0"  <?php if(!$show_icat) echo 'checked';?>/> 關閉
</td>
</tr>

<tr>
<td class="tl">首頁顯示按地區瀏覽</td>
<td>
<input type="radio" name="setting[show_iarea]" value="1"  <?php if($show_iarea) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_iarea]" value="0"  <?php if(!$show_iarea) echo 'checked';?>/> 關閉
</td>
</tr>

<tr>
<td class="tl">首頁點擊排行數量</td>
...
<tr>
<td class="tl">列表顯示按分類瀏覽</td>
<td>
<input type="radio" name="setting[show_lcat]" value="1"  <?php if($show_lcat) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_lcat]" value="0"  <?php if(!$show_lcat) echo 'checked';?>/> 關閉
</td>
</tr>

<tr>
<td class="tl">列表顯示按地區瀏覽</td>
<td>
<input type="radio" name="setting[show_larea]" value="1"  <?php if($show_larea) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_larea]" value="0"  <?php if(!$show_larea) echo 'checked';?>/> 關閉
</td>
</tr>

<tr>
<td class="tl">列表搜索排行數量</td>
<td><input type="text" size="3" name="setting[page_lkw]" value="<?php echo $page_lkw;?>"/></td>
</tr>

<tr>
<td class="tl">內容顯示留言咨詢</td>
<td>
<input type="radio" name="setting[show_message]" value="1"  <?php if($show_message) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[show_message]" value="0"  <?php if(!$show_message) echo 'checked';?>/> 關閉
</td>
</tr>

<tr>
<td class="tl">內容相關信息數量</td>
...
<tr>
<td class="tl">留言啟用驗證碼</td>
<td>
<input type="radio" name="setting[captcha_message]" value="2"  <?php if($captcha_message == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_message]" value="1"  <?php if($captcha_message == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_message]" value="0"  <?php if($captcha_message == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">留言啟用驗問題</td>
<td>
<input type="radio" name="setting[question_message]" value="2"  <?php if($question_message == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_message]" value="1"  <?php if($question_message == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_message]" value="0"  <?php if($question_message == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
