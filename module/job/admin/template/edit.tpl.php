...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 招聘部門</td>
...
<td><input name="post[total]" type="text" id="total" size="6" value="<?php echo $total;?>"/> 人 (填0為若干)</td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 待遇水平</td>
<td><input name="post[minsalary]" type="text" id="minsalary" size="6" value="<?php echo $minsalary;?>"/> 至 <input name="post[maxsalary]" type="text" id="maxsalary" size="6" value="<?php echo $maxsalary;?>"/> <?php echo $DT['money_unit'];?>/月 (填0為面議)</td>
</tr>
<tr>
...
<td><input name="post[minage]" type="text" id="minage" size="5" value="<?php echo $minage;?>"/> 至 <input name="post[maxage]" type="text" id="maxage" size="5" value="<?php echo $maxage;?>"/> 週歲 (填0為不限)</td>
</tr>
<tr>
...
<tr>
<td class="tl"><span class="f_red">*</span> 職位描述</td>
...
<td class="tr"><input name="post[company]" type="text" id="company" size="50" value="<?php echo $company;?>" /> 個人請填姓名<br/><span id="dcompany" class="f_red"></span> </td>
</tr>
</tbody>
<tr>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 招聘狀態</td>
<td>
