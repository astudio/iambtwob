...
<input type="submit" value=" 更新信息 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';" title="更新該模塊所有信息地址等項目"/>
</td>
</tr>
</table>
</form>
<form method="post">
<div class="tt">生成招聘</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<th>起始ID</th>
<th>結束ID</th>
...
<td><input type="text" size="5" name="num" value="100"/></td>
<td>
<input type="submit" value=" 更新簡歷 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=update_resume';"/>
</td>
</tr>
</table>
</form>
