...
$menus = array (
    ...
    array('簡歷字段', '?file=fields&tb=resume'),
...
<tr>
<td class="tl">工作類型</td>
<td><input type="text" size="60" name="setting[type]" value="<?php echo $type;?>"/><?php tips('不同類別用 | 分隔，設置好後，請勿頻繁改動');?></td>
</tr>
<tr>
<td class="tl">性別名稱</td>
...
<tr>
<td class="tl">查看簡歷收費</td>
<td><input type="text" size="5" name="setting[fee_view_resume]" value="<?php echo $fee_view_resume;?>"/> <?php echo $fee_currency == 'money' ? $DT['money_unit'] : $DT['credit_unit'];?>/條</td>
</tr>
<tr>
...
<tr>
<td class="tl">允許瀏覽招聘列表</td>
<td><?php echo group_checkbox('setting[group_list][]', $group_list);?></td>
</tr>
<tr>
<td class="tl">允許瀏覽招聘信息</td>
<td><?php echo group_checkbox('setting[group_show][]', $group_show);?></td>
</tr>

<tr>
<td class="tl">允許瀏覽招聘聯繫方式</td>
<td><?php echo group_checkbox('setting[group_contact][]', $group_contact);?></td>
</tr>

<tr>
<td class="tl">允許搜索招聘</td>
<td><?php echo group_checkbox('setting[group_search][]', $group_search);?></td>
</tr>

<tr>
<td class="tl">允許應聘職位</td>
<td><?php echo group_checkbox('setting[group_apply][]', $group_apply);?></td>
</tr>

<tr>
<td class="tl">審核發佈簡歷</td>
<td>
<input type="radio" name="setting[check_add_resume]" value="2"  <?php if($check_add_resume == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[check_add_resume]" value="1"  <?php if($check_add_resume == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[check_add_resume]" value="0"  <?php if($check_add_resume == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">發佈簡歷啟用驗證碼</td>
<td>
<input type="radio" name="setting[captcha_add_resume]" value="2"  <?php if($captcha_add_resume == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_add_resume]" value="1"  <?php if($captcha_add_resume == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_add_resume]" value="0"  <?php if($captcha_add_resume == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">發佈簡歷啟用驗問題</td>
<td>
<input type="radio" name="setting[question_add_resume]" value="2"  <?php if($question_add_resume == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_add_resume]" value="1"  <?php if($question_add_resume == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_add_resume]" value="0"  <?php if($question_add_resume == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">發佈簡歷收費</td>
<td><input type="text" size="5" name="setting[fee_add_resume]" value="<?php echo $fee_add_resume;?>"/> <?php echo $fee_currency == 'money' ? $DT['money_unit'] : $DT['credit_unit'];?>/條</td>
</tr>
<tr>
<td class="tl">查看招聘收費</td>
