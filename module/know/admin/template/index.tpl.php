...
<input type="submit" value=" 激活問題 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=active';" title="激活已關閉問題 並延長過期時間"/>&nbsp;
