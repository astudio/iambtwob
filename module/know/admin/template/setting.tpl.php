...
<tr>
<td class="tl">清除答案鏈接</td>
<td>
<input type="radio" name="setting[clear_alink]" value="1"  <?php if($clear_alink) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[clear_alink]" value="0"  <?php if(!$clear_alink) echo 'checked';?>/> 關閉
</td>
</tr>
<tr>
...
<tr>
<td class="tl">懸賞<?php echo $DT['credit_name'];?>備選</td>
<td><input type="text" size="60" name="setting[credits]" value="<?php echo $credits;?>"/></td>
</tr>
<tr>
<td class="tl">有回復時發消息給提問者</td>
<td>
<input type="radio" name="setting[answer_message]" value="1"  <?php if($answer_message) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[answer_message]" value="0"  <?php if(!$answer_message) echo 'checked';?>/> 關閉
</td>
</tr>
<tr>
<td class="tl">問題默認過期時間</td>
...
<tr>
<td class="tl">審核發佈答案</td>
<td>
<input type="radio" name="setting[check_answer]" value="2"  <?php if($check_answer == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[check_answer]" value="1"  <?php if($check_answer == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[check_answer]" value="0"  <?php if($check_answer == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">發佈答案啟用驗證碼</td>
<td>
<input type="radio" name="setting[captcha_answer]" value="2"  <?php if($captcha_answer == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_answer]" value="1"  <?php if($captcha_answer == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_answer]" value="0"  <?php if($captcha_answer == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">發佈答案啟用驗問題</td>
<td>
<input type="radio" name="setting[question_answer]" value="2"  <?php if($question_answer == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_answer]" value="1"  <?php if($question_answer == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_answer]" value="0"  <?php if($question_answer == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
