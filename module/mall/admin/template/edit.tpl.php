...
<tr>
<td class="tl"><span class="f_red">*</span> 商品分類</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 商品名稱</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 商品圖片</td>
<td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 商品詳情</td>
...
function check() {
	...
	f = 'catid_1';
	if(Dd(f).value == 0) {
		Dmsg('請選擇商品分類', 'catid', 1);
		return false;
	}
	f = 'title';
	l = Dd(f).value.length;
	if(l < 2) {
		Dmsg('商品名稱最少2字，當前已輸入'+l+'字', f);
		return false;
	}
	f = 'price';
	l = Dd(f).value;
