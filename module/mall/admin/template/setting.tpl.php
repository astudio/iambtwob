...
<tr>
<td class="tl">購物車容量</td>
<td><input type="text" size="3" name="setting[max_cart]" value="<?php echo $max_cart;?>"/> <?php tips('超出容量之後，系統自動刪除最早加入購物車的商品，為了系統效率，建議控制在50內');?></td>
</tr>

<tr>
<td class="tl">首頁推薦商品數量</td>
<td><input type="text" size="3" name="setting[page_irec]" value="<?php echo $page_irec;?>"/></td>
</tr>

<tr>
<td class="tl">首頁最新商品數量</td>
