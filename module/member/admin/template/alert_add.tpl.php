...
<td><textarea name="post[username]" id="username" style="width:200px;height:100px;overflow:visible;"><?php echo $username;?></textarea><?php tips('允許批量添加，一行一個，點回車換行');?><br/><span id="dusername" class="f_red"></span></td>
</tr>
<tr>
