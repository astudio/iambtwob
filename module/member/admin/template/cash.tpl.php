...
<option value="addtime" <?php if($timetype == 'addtime') echo 'selected';?>>申請時間</option>
<option value="edittime" <?php if($timetype == 'edittime') echo 'selected';?>>受理時間</option>
</select>&nbsp;
<?php echo dcalendar('fromtime', $fromtime);?> 至 <?php echo dcalendar('totime', $totime);?>&nbsp;
<select name="mtype">
<option value="amount" <?php if($mtype == 'amount') echo 'selected';?>>金額</option>
