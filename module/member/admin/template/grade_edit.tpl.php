...
<tr>
<td class="tl"><span class="f_hid">*</span> 會員組</td>
<td class="f_blue"><?php echo $GROUP[$user['groupid']]['groupname'];?></td>
</tr>
</table>
<?php } ?>
<div class="tt">升級申請</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl"><span class="f_hid">*</span> 會員組</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 聯繫人</td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 已付金額</td>
<td class="f_b f_red"><?php echo $amount;?></td>
</tr>
<?php if($promo_code) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 優惠碼</td>
<td><?php echo $promo_code;?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 優惠幅度</td>
<td class="f_blue"><?php echo $promo_amount;?> <?php echo $promo_type ? '天' : $DT['money_unit'];?></td>
</tr>
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 申請時間</td>
<td><?php echo $addtime;?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 申請IP</td>
<td><?php echo $ip;?> - <?php echo ip2area($ip);?></td>
</tr>
</table>
<div class="tt"><span class="f_hid">*</span> 申請受理</div>
...
<input type="radio" name="post[status]" value="3" id="s_3" onclick="S(this.value);"/><label for="s_3"> 通過</label>
<input type="radio" name="post[status]" value="2" id="s_2" onclick="S(this.value);" checked/><label for="s_2"> 待審</label>
<input type="radio" name="post[status]" value="1" id="s_1" onclick="S(this.value);"/><label for="s_1">  拒絕</label>
</td>
</tr>
<tbody id="pass" style="display:none;">
<?php if($user && $fee) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 會員組年費</td>
...
<?php } ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 會員已支付</td>
<td class="f_blue"><?php echo $amount;?> <?php echo $DT['money_unit'];?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 需支付金額</td>
<td class="f_blue"><input type="text" name="post[pay]" size="5" value="<?php echo $pay;?>"/> <?php echo $DT['money_unit'];?>&nbsp;&nbsp;&nbsp;<a href="?moduleid=2&file=record&action=add&username=<?php echo $username;?>" class="t" target="_blank">[<?php echo $DT['money_name'];?>管理]</a>&nbsp;&nbsp;<span class="f_gray">(會員當前賬戶餘額:<?php echo $user['money'];?><?php echo $DT['money_unit'];?>)</span></td>
</tr>
<tr>
...
<?php if($user) { ?>
<tr>
<td class="tl"><span class="f_hid">*</span> 發送通知</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 受理狀態</td>
<td><?php echo $status == 1 ? '已拒絕' : '已通過';?></td>
</tr>
<tr>
<td class="tl"><span class="f_hid">*</span> 受理通知</td>
<td><?php echo $message == 1 ? '已發送' : '未通知';?></td>
</tr>
<tr>
