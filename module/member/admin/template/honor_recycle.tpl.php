...
<input type="submit" value=" 還 原 " class="btn" onclick="if(confirm('確定要還原選中證書嗎？狀態將被設置為已通過')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=restore'}else{return false;}"/>&nbsp;
