...
<option value="1"<?php echo $read==1 ? ' selected' : '';?>>已讀</option>
<option value="0"<?php echo $read==0 ? ' selected' : '';?>>未讀</option>
</select>&nbsp;
<select name="send">
<option value="-1">轉發</option>
<option value="1"<?php echo $send==1 ? ' selected' : '';?>>已發</option>
<option value="0"<?php echo $send==0 ? ' selected' : '';?>>未發</option>
</select>
&nbsp;
...
<div class="btns">
<input type="submit" value=" 刪 除 " class="btn" onclick="if(confirm('確定要刪除選中信件嗎？此操作將不可撤銷')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>
</div>
</form>
