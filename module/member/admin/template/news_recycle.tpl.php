...
<div class="btns">
<input type="submit" value=" 徹底刪除 " class="btn" onclick="if(confirm('確定要刪除選中新聞嗎？此操作將不可撤銷')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=delete'}else{return false;}"/>&nbsp;
<input type="submit" value=" 還 原 " class="btn" onclick="if(confirm('確定要還原選中新聞嗎？狀態將被設置為已通過')){this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=restore'}else{return false;}"/>&nbsp;
