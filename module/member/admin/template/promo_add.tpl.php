...
<div class="tt">生成優惠碼</div>
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl"><span class="f_hid">*</span> 優惠碼前綴</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 優惠碼組成</td>
...
<option value="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ" selected>數字和大寫字母</option>
</select>
<span id="dnumber_part" class="f_red"></span></td>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 優惠碼長度</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 優惠用途</td>
<td>
<input type="radio" name="type" value="0" id="t_0" onclick="Dd('am').innerHTML='<?php echo $DT['money_unit'];?>';" checked/><label for="t_0"> 抵金額</label>&nbsp;&nbsp;
<input type="radio" name="type" value="1" id="t_1" onclick="Dd('am').innerHTML='天 <span class=f_gray>自使用時間開始計算</span>';"/><label for="t_1"> 有效期</label>
</tr>
<tr>
<td class="tl"><span class="f_red">*</span> 優惠額度</td>
...
<tr>
<td class="tl"><span class="f_red">*</span> 重複使用</td>
