...
<option value="2"<?php echo $open == 2 ? ' selected' : '';?>>密碼驗證</option>
<option value="1"<?php echo $open == 1 ? ' selected' : '';?>>問題驗證</option>
</select>&nbsp;
...
<td>
<a href="?moduleid=<?php echo $moduleid;?>&action=item&itemid=<?php echo $v['itemid'];?>"><img src="admin/image/photo.gif" width="16" height="16" title="管理圖片" alt=""/></a>&nbsp;
