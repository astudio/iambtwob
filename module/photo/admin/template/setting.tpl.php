...
<tr>
<td class="tl">圖集內圖片數量限制</td>
<td><input type="text" size="3" name="setting[maxitem]" value="<?php echo $maxitem;?>"/> 張 最少為1，推薦控制在30內</td>
</tr>
<tr>
...
<tr>
<td class="tl">單此批量上傳數量限制</td>
<td><input type="text" size="3" name="setting[swfu_max]" value="<?php echo $swfu_max;?>"/> <?php tips('此項僅針對前台會員上傳，-1表示禁止批量傳圖，0表示單次上傳不限制數量，具體數字表示單次上傳限制的圖片數量<br/>注意：此功能在會員模塊綁定二級域名的情況下將不可用');?></td>
</tr>
