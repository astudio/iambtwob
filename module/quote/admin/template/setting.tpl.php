...
<tr>
<td class="tl">自動生成報價單</td>
<td>
<input type="radio" name="setting[quote_auto]" value="1"  <?php if($quote_auto) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[quote_auto]" value="0"  <?php if(!$quote_auto) echo 'checked';?>/> 關閉
</td>
</tr>
<tr>
<td class="tl">報價單產品匹配</td>
<td>
<input type="radio" name="setting[quote_match]" value="1"  <?php if($quote_match) echo 'checked';?>> 模糊&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[quote_match]" value="0"  <?php if(!$quote_match) echo 'checked';?>> 精確
</td>
</tr>
<tr>
<td class="tl">報價單人工審核</td>
<td>
<input type="radio" name="setting[quote_check]" value="1"  <?php if($quote_check) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[quote_check]" value="0"  <?php if(!$quote_check) echo 'checked';?>/> 關閉
</td>
</tr>
<tr>
<td class="tl">報價單附加條件</td>
<td><input type="text" size="30" name="setting[quote_condition]" value="<?php echo $quote_condition;?>"/><?php tips('此項針對供應產品表,例如可設置AND level>0 AND vip>0');?>
</td>
</tr>
<tr>
<td class="tl">報價單最少產品數量</td>
<td><input type="text" size="5" name="setting[quote_min]" value="<?php echo $quote_min;?>"/>
</td>
</tr>
<tr>
<td class="tl">報價單最大產品數量</td>
