...
<br/><input type="button" value="搜索分類" onclick="schcate(<?php echo $moduleid;?>);" class="btn"/> <span id="dcatid" class="f_red"></span></td>
</tr>
<?php if($CP) { ?>
...
?>
<tr>
<td class="tl"><span class="f_hid">*</span> 產品圖片</td>
<td>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 交易條件</td>
<td>
	<table width="100%">
	<tr>
	<td width="70">計量單位</td>
	<td><input name="post[unit]" type="text" size="10" value="<?php echo $unit;?>" onblur="if(this.value){Dd('u1').innerHTML=Dd('u2').innerHTML=Dd('u3').innerHTML=this.value;}" id="u0"/><input type="hidden" id="uu" value="單位"/></td>
	</tr>
	<tr>
	<td>產品單價</td>
	<td><input name="post[price]" type="text" size="10" value="<?php echo $price;?>"/> <?php echo $DT['money_unit'];?>/<span id="u1"><?php echo $unit ? $unit : '單位';?></span></td>
	</tr>
	<tr>
	<td>最小起訂量</td>
	<td><input name="post[minamount]" type="text" size="10" value="<?php echo $minamount;?>"/> <span id="u2"><?php echo $unit ? $unit : '單位';?></span></td>
	</tr>
	<tr>
	<td>供貨總量</td>
	<td><input name="post[amount]" type="text" size="10" value="<?php echo $amount;?>"/> <span id="u3"><?php echo $unit ? $unit : '單位';?></span></td>
	</tr>
	<tr>
	<td>發貨期限</td>
	<td>自買家付款之日起 <input name="post[days]" type="text" size="2" value="<?php echo $days;?>"/> 天內發貨</td>
	</tr>
	</table>
</td>
</tr>
...
<tr>
<td class="tl"><span class="f_hid">*</span> 會員推薦產品</td>
<td>
