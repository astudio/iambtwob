...
<tr>
<td class="tl"><?php echo $MOD['name'];?>類別</td>
...
<td>
<input type="radio" name="setting[sphinx]" value="1" <?php if($sphinx) echo 'checked';?> onclick="Ds('sphinx');"/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[sphinx]" value="0" <?php if(!$sphinx) echo 'checked';?> onclick="Dh('sphinx');"/> 關閉
</td>
</tr>
...
<tr>
<td class="tl">允許自主推薦到網站首頁</td>
<td><?php echo group_checkbox('setting[group_elite][]', $group_elite);?></td>
</tr>
<tr>
<td class="tl">詢價啟用驗證碼</td>
<td>
<input type="radio" name="setting[captcha_inquiry]" value="2"  <?php if($captcha_inquiry == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_inquiry]" value="1"  <?php if($captcha_inquiry == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[captcha_inquiry]" value="0"  <?php if($captcha_inquiry == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
<td class="tl">詢價啟用驗問題</td>
<td>
<input type="radio" name="setting[question_inquiry]" value="2"  <?php if($question_inquiry == 2) echo 'checked';?>> 繼承會員組設置&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_inquiry]" value="1"  <?php if($question_inquiry == 1) echo 'checked';?>> 全部啟用&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[question_inquiry]" value="0"  <?php if($question_inquiry == 0) echo 'checked';?>> 全部關閉
</td>
</tr>
<tr>
