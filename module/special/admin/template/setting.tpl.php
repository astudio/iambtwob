...
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">允許瀏覽<?php echo $MOD['name'];?>首頁</td>
...
<tr>
<td class="tl">允許瀏覽<?php echo $MOD['name'];?>內容</td>
<td><?php echo group_checkbox('setting[group_show][]', $group_show);?></td>
</tr>

<tr>
<td class="tl">允許搜索<?php echo $MOD['name'];?></td>
...
<table cellpadding="2" cellspacing="1" class="tb">
<tr>
<td class="tl">發佈<?php echo $MOD['name'];?>獎勵</td>
<td>
<input type="text" size="5" name="setting[credit_add]" value="<?php echo $credit_add;?>"/>
</td>
</tr>
<tr>
<td class="tl"><?php echo $MOD['name'];?>被刪除扣除</td>
<td>
