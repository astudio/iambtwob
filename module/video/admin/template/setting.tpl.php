...
<tr>
<td class="tl">視頻播放器</td>
<td><input type="text" name="setting[player]" size="60" value="<?php echo $player;?>"/></td>
</tr>
<tr>
<td class="tl">內容頁自動播放視頻</td>
<td>
<input type="radio" name="setting[autostart]" value="1"  <?php if($autostart) echo 'checked';?>/> 開啟&nbsp;&nbsp;&nbsp;&nbsp;
<input type="radio" name="setting[autostart]" value="0"  <?php if(!$autostart) echo 'checked';?>/> 關閉
</td>
</tr>
<tr>
<td class="tl">FLV播放器LOGO</td>
<td><input type="text" name="setting[flvlogo]" size="30" value="<?php echo $flvlogo;?>"/><?php tips('請填寫問名稱，建議製作透明PNG格式，覆蓋file/image/video.png');?><br/>
...
<tr>
<td class="tl">FLV播放器LOGO鏈接</td>
<td><input type="text" name="setting[flvlink]" size="60" value="<?php echo $flvlink;?>"/><?php tips('請填寫http://開頭的絕對地址，留空默認鏈接至網站首頁');?></td>
</tr>
<tr>
<td class="tl">FLV播放器片頭廣告</td>
<td><input type="text" name="setting[flvstart]" size="60" value="<?php echo $flvstart;?>" id="flvstart"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('flvstart').value, 'flvstart', 'flv|mp4');" class="jt">[上傳]</span>&nbsp;&nbsp;<span onclick="Dd('flvstart').value='';" class="jt">[刪除]</span> <?php tips('請填寫http://開頭的絕對地址，目前支持FLV、MP4格式');?></td>
</tr>
<tr>
<td class="tl">FLV播放器片尾廣告</td>
<td><input type="text" name="setting[flvend]" size="60" value="<?php echo $flvend;?>" id="flvend"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, Dd('flvend').value, 'flvend', 'flv|mp4');" class="jt">[上傳]</span>&nbsp;&nbsp;<span onclick="Dd('flvend').value='';" class="jt">[刪除]</span> <?php tips('請填寫http://開頭的絕對地址，目前支持FLV、MP4格式');?></td>
</tr>
<tr>
...
<input type="radio" name="setting[swfu]" value="2"  <?php if($swfu==2) echo 'checked';?>/> 後台開啟 <?php tips('開啟後，系統將採用SWFUpload上傳文件，並帶有進度提示');?>
</td>
</tr>
