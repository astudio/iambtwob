...
if($userid || $username) {
	...
	if($action == 'introduce') {
		...
		$head_title = '公司介紹'.$DT['seo_delimiter'].$company.$DT['seo_delimiter'].$MOD['name'].$DT['seo_delimiter'].$head_title;
	} else if($action == 'news') {
		$table = $DT_PRE.'news';
		...
		if($itemid) {
			...
			$head_title = $title.$DT['seo_delimiter'].'新聞中心'.$DT['seo_delimiter'].$company.$DT['seo_delimiter'].$MOD['name'].$DT['seo_delimiter'].$head_title;;
			//$content = $content['content'];
			...
			$head_title = '新聞中心'.$DT['seo_delimiter'].$company.$DT['seo_delimiter'].$MOD['name'].$DT['seo_delimiter'].$head_title;
		}
	} else if($action == 'sell') {
		$table = $DT_PRE.'sell';
		...
		if($itemid) {
			...
			$head_title = '產品展示'.$DT['seo_delimiter'].$company.$DT['seo_delimiter'].$MOD['name'].$DT['seo_delimiter'].$head_title;
		}
	} else {
